           ...
           <div class="panel-body">
                ...
                <div class="col-xs-12 col-md-12">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for=''>Fax</label>
                            {!! Form::text('fax',!empty($company->fax)?$company->fax:'',['class' => 'form-control', 'required'=>'' ]) !!}
                        </div>
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('city',(!empty($company->city))?$company->city:null,['class' => 'form-control','required' => '']) !!}
                </div>
                <div class="form-group">
                    <label for='province_id'>State</label>
                    {!! Form::select('province',$province ,!empty($company->province_id)?$company->province_id:null, ['class'=>'form-control', 'required'=>true] ) !!}
                </div>

                <div class="form-group">
                    <label for='postal_code'>Postal Code</label>
                    {!! Form::text('postal_code',(!empty($company->postal_code))?$company->postal_code:null,['class' => 'form-control','required' => '']) !!}
                </div> 
            </div>
